...
class Store {
  ...
  studentsConstJsonLoadData = async () => {
    const studentsData = await fetch('/data/studentConst.json').then(response => response.json());
  ...
  tasksTagLoadData = async () => {
    const taskTagData = await fetch('/data/tasksTag.json').then(response => response.json());
    this.taskTag = taskTagData;
  };

  tasksJsonLoadData = async () => {
    const tasksData = await fetch('/data/tasks.json').then(response => response.json());
